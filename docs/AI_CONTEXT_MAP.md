...
| Pricing / integrations | `PROJECT.md`, relevant integration docs | `src/lib/finnhub-service.ts`, `src/lib/coinmarketcap-service.ts`, relevant API routes |
...
| Dashboard / portfolio UI | `ARCHITECTURE.md`, `WORKFLOWS.md` | `src/components/PortfolioDashboardClient.tsx`, `src/components/PortfolioV3MainClient.tsx` |
...
| Export | `PROJECT.md`, `WORKFLOWS.md` | export route/components identified by code search |
